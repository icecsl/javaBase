...
public class Hex {
  ...
  public static void main(String[] args) throws Exception {
    if(args.length == 0)
      ...
      System.out.println(
        format(BinaryFile.read("out/production/javaBase/thinkingInJava/strings/Hex.class")));
//        format(BinaryFile.read("src/thinkingInJava/strings/Hex.java")));
//        format(BinaryFile.read("/Users/huangbingjing/studyPro/javaBase/src/thinkingInJava/strings/Hex.java")));
    else
      System.out.println(
